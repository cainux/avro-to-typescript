...
chai.should();
const avroFolder = path.resolve(utils_1.dataDir() + `/avro/`);
const expectedFolder = path.resolve(utils_1.dataDir() + `/expected/`);
const compiledFolder = path.resolve(utils_1.dataDir() + `/compiled/`);
